<template>
  <div class="rounded-lg border border-neutral-200 p-3 dark:border-neutral-800">
    ...
    <div
      ...
      class="rounded-md bg-neutral-50 px-3 py-2 text-sm text-neutral-500 dark:bg-neutral-950 dark:text-neutral-400"
    >
      Tanpa diskon.
    </div>
    <div v-else class="space-y-2">
      <div
        ...
        :key="index"
        class="grid grid-cols-[1fr_auto_auto_auto] items-end gap-2"
      >
        <AppTextInput
